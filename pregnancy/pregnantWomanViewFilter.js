...
class PregnantWomenEnrolmentViewHandler {
    ...
    @WithRegistrationStatusBuilder
    a15([], statusBuilder) {
        statusBuilder.show().when.valueInEnrolment("Place you will do your delivery")
        .containsAnswerConceptName("Other");
    } 
    ...
    @WithRegistrationStatusBuilder
    a18([], statusBuilder) {
        statusBuilder.show().when.valueInEnrolment("Available on mamta divas")
        .containsAnswerConceptName("Other");
    }
    ...
    @WithRegistrationStatusBuilder
    a21([], statusBuilder) {
        statusBuilder.show().when.valueInEnrolment("What did you get in snacks")
        .containsAnswerConceptName("Other");
    }
    ...
    @WithRegistrationStatusBuilder
    a59([], statusBuilder) {
        statusBuilder.show().when.valueInEnrolment("Decision taken for place of delivery").is.yes;
    }
